                        ...
                        <div class="row page-title">
                            <div class="col-md-12">
                                <nav aria-label="breadcrumb" class="float-right mt-1">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#">University Portal</a></li>
         ...
         <!-- select -->
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title mt-0 mb-1">Select Courses</h4>

                                        <form action="/UniversityProtal/onChangeResultProcess" method="post">
                                            <div class="row">
                                                <div class="col-xl-4 col-sm-8">
                                                    <div class="form-group mt-3 mt-sm-0">

                                                        <select  class="form-control" id="findCourses" name="findCourses">

                                                            <c:forEach items="${allCoursesResult}" var="courses">
                                                                <option value="${courses.coursesName}">${courses.coursesName}</option>
                                                            </c:forEach>
                                                                <input type="hidden" id="CoursesResultNameById" name="CoursesResultNameById"/>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-2 col-sm-4">
                                                    <div class="form-group mt-3 mt-sm-0">
                                                        <label></label>
                                                        <button type="submit" class="btn btn-primary width-lg">Search</button>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title mt-0 mb-1">Student Result Process</h4>
                                      
                                        <form action="/UniversityProtal/saveResulr" method="post">
                                               ...
                                               <table id="key-datatable" class="table dt-responsive nowrap">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Class Test Out of -20</th>
                                                        <th>Mid Tram out of -30</th>
                                                        <th>Final Out of -50</th>
                                                ...
                                                <tbody>
                                                    <c:forEach items="${allStudent}" var="user">
                                                        <tr>

                                                            <td>${user.studentsId}</td>
                                                            <td>${user.name}</td>
                                                            <td>
                                                                <input type="number" name="classTest[]" />
                                                            </td>
                                                            <td>
                                                                <input type="number" name="midTrem[]" />
                                                            </td>
                                                            <td>
                                                    ...
                                                    <input type="hidden" value="${user.studentsId}" name="student_id[]" />
                                                    <input type="hidden" value="${user.name}" name="student_name[]" />
                                                    <input type="hidden" value="${user.facultyName}" name="faculty_name[]" />
                                                    <input type="hidden" value="${user.departmentName}" name="department_name[]" />
                                                    <input type="hidden" value="${user.coursesName}" name="courses_name[]" />
                                                    <input type="hidden" value="${user.courseCode}" name="coursesCode_name[]" />
                                                    <input type="hidden" value="${user.courseCradit}" name="coursesCradit_name[]" />
                                                    <input type="hidden" value="${user.coursePrice}" name="coursesPrice_name[]" />
                                                    <input type="hidden" value="${user.batchName}" name="batch_name[]" />
                                               ...
                                               <button type="submit" class="btn btn-primary width-lg">Result Published</button>
<!--                                            <input type="submit" value="save"/>-->
        ...
        <script src="static/assets/js/app.min.js"></script>
            ...
            <script>
                        $("#CoursesResultNameById").val($("#findCourses option:selected").val());

                         $("#findCourses").on("change", function (){
                             $("#CoursesResultNameById").val($("#findCourses option:selected").val());
                         });
