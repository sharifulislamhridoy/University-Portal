    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="navbar navbar-expand flex-column flex-md-row navbar-custom">
                <div class="container-fluid">
                    ...
                    <a href="/UniversityProtal/" class="navbar-brand mr-0 mr-md-2 logo">
                        <span class="logo-lg">
                                ...
                                <div class="card">
                                    <div class="card-body pt-2">
                                        ...
                                        <div class="media border-top pt-3">
                                            <img src="static/assets/images/users/avatar-7.jpg" class="avatar rounded mr-3"
                                                alt="shreyu">
                                            <div class="media-body">
                                        ...
                                        <div class="media mt-1 border-top pt-3">
                                            <img src="static/assets/images/users/avatar-9.jpg" class="avatar rounded mr-3"
                                                alt="shreyu">
                                            <div class="media-body">
                                        ...
                                        <div class="media mt-1 border-top pt-3">
                                            <img src="static/assets/images/users/avatar-4.jpg" class="avatar rounded mr-3"
                                                alt="shreyu">
                                            <div class="media-body">
                                        ...
                                        <div class="media mt-1 border-top pt-3">
                                            <img src="static/assets/images/users/avatar-1.jpg" class="avatar rounded mr-3"
                                                alt="shreyu">
                                            <div class="media-body">
                                        ...
                                        <div class="media mt-1 border-top pt-3">
                                            <img src="static/assets/images/users/avatar-5.jpg" class="avatar rounded mr-3"
                                                alt="shreyu">
                                            <div class="media-body">
                                            ...
                                            <ul class="conversation-list slimscroll" style="max-height: 328px;">
                                                <li class="clearfix">
                                                    <div class="chat-avatar">
                                                        <img src="static/assets/images/users/avatar-9.jpg" alt="Female">
                                                        <i>10:00</i>
                                                    </div>
                                                ...
                                                <li class="clearfix odd">
                                                    <div class="chat-avatar">
                                                        <img src="static/assets/images/users/avatar-7.jpg" alt="Male">
                                                        <i>10:01</i>
                                                    </div>
                                                    <div class="conversation-text">
                                                        <div class="ctext-wrap">
        ...
        <div class="right-bar">
            ...
            <div class="slimscroll-menu">
                ...
                <div class="p-3">
                    <h6>Default</h6>
                    <a href="index.html"><img src="static/assets/images/layouts/vertical.jpg" alt="vertical" class="img-thumbnail demo-img" /></a>
                </div>
                <div class="px-3 py-1">
                    <h6>Top Nav</h6>
