...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="container-fluid">
                        <div class="row page-title">
                            <div class="col-md-12">
                                ...
                                <h4 class="mb-1 mt-0">Attendance Tables</h4>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="/UniversityProtal/onChange" method="post">
                                            <div class="row">
                                              <div class="col-xl-4 col-sm-8">
                                                    <div class="form-group mt-3 mt-sm-0">

                                                        <select  class="form-control" id="findStudent" name="findStudent">

                                                            <c:forEach items="${allCourses}" var="courses">
                                                                <option value="${courses.coursesName}">${courses.coursesName}</option>
                                                            </c:forEach>
                                                                <input type="hidden" id="CoursesNameById" name="CoursesNameById"/>
                                                        </select>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title mt-0 mb-1">Attendance Sheet</h4>

                                        <form action="/UniversityProtal/save" method="post">

                                           <table id="key-datatable" class="table dt-responsive nowrap">
                                                <br> <button type="submit" class="btn btn-primary width-lg">Attendance Published</button>
                                                <thead>
                                                    <tr>
                                                        <th>Status </th>
                                                        <th>ID</th>
                                                ...
                                                <tbody>
                                                    <c:forEach items="${allStudentById}" var="user">
                                                        <tr>
                                                            <td>
                                                                <input type="checkbox" name="attendance_status[]" value="${user.studentsId}"/>
                                                            </td>
                                                            <td>${user.studentsId}</td>
                                                            <td>${user.name}</td>
                                                            <td>${user.facultyName}</td>
                                                            <td>${user.coursesName}</td>
                                                    ...
                                                    <input type="hidden" value="${user.professorName}" name="professor_name[]" />
        ...
        <div class="right-bar">
            ...
            <script>
                        $("#CoursesNameById").val($("#findStudent option:selected").val());

                         $("#findStudent").on("change", function (){
                             $("#CoursesNameById").val($("#findStudent option:selected").val());
                         });
