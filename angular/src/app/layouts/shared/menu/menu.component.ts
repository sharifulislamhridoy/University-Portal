...
import { STUDENT } from './studentMenu';
import { AuthenticationService } from 'src/app/core/services/auth.service';
import { TEACHER } from './teacherMenu';
...
condition :string ='admin';
  ...
  initialize(): void {
     ...
     }else if(this.authenticationService.user.lastName=='admin'){
      this.menuItems = MENU;
     }else{
      this.menuItems = TEACHER;
     }
